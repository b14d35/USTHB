...
int main() {
    ...
    for (i=0;i<N;i++) {
        ...
        do {
            scanf("%c",&T[i].vi);
        } while (T[i].vi=='\n' || (T[i].vi!='0' && T[i].vi!='1' && T[i].vi!='*' && T[i].vi!='#'));
        ...
        } while (T[i].vs=='\n' || (T[i].vs!='0' && T[i].vs!='1' && T[i].vs!='*' && T[i].vs!='G' && T[i].vs!='D' && T[i].vs!='#'));
    ...
    case '1':  goto g;
        break;
    case '2':  affichage(T,N);
                system("pause");
        break;
    case '3':  printf("Donnez la position de l'instruction a changer : \t");
            do {
                scanf("%d",&P);
            } while (P<1 || P>N);
            printf("Instruction %d :\n",P);
        ...
        do {
            scanf("%c",&T[P].vi);
        } while (T[P].vi=='\n' || (T[P].vi!='0' && T[P].vi!='1' && T[P].vi!='*' && T[P].vi!='#'));
        printf("Valeur suivante : \t");
        do {
            scanf("%c",&T[P].vs);
            if (T[P].vs=='g') {
        ...
        } while (T[P].vs=='\n' || (T[P].vs!='0' && T[P].vs!='1' && T[P].vs!='*' && T[P].vs!='G' && T[P].vs!='D' && T[P].vs!='#'));
        printf("Etat suivant : \tq");
        do {
            scanf("%c",&T[P].es);
        } while (T[P].es=='\n');
    ...
    case '4':
        ...
        do {
            scanf("%c",&T[N].vi);
        } while (T[N].vi=='\n' || (T[N].vi!='0' && T[N].vi!='1' && T[N].vi!='*' && T[N].vi!='#'));
        printf("Valeur suivante : \t");
        do {
            scanf("%c",&T[N].vs);
            if (T[N].vs=='g') {
        ...
        } while (T[N].vs=='\n' || (T[N].vs!='0' && T[N].vs!='1' && T[N].vs!='*' && T[N].vs!='G' && T[N].vs!='D' && T[N].vs!='#'));
        printf("Etat suivant : \tq");
        do {
            scanf("%c",&T[N].es);
        } while (T[N].es=='\n');
        ...
        s:
            for (i=0;i<N;i++) {
                if (A[t]==T[i].ei && B[t]==T[i].vi) {
                    if (T[i].vs=='0' || T[i].vs=='1' || T[i].vs=='*' || T[i].vs=='#') {
                        B[t]=T[i].vs;
                        A[t]=T[i].es;
                        printf("\n\n");
                        for (i=0;i<300;i++) {
            ...
            for (i=0;i<300;i++) {
                if (B[i]=='1') {
                    if (i!=t) {
                        printf("Attention le curseur n'est pas sur le premier 1\n\n");
                    }
                    break;
                }
            }
